...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.137114 && value <= -0.076444) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.076444 && value <= -0.015773) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.015773 && value <= 0.044898) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.044898 && value <= 0.105569) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.105569 && value <= 0.166240) {
            style = [ new ol.style.Style({
