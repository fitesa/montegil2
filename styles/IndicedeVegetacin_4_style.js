...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.088767 && value <= 0.165811) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.165811 && value <= 0.242856) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.242856 && value <= 0.319900) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.319900 && value <= 0.396944) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.396944 && value <= 0.473988) {
            style = [ new ol.style.Style({
